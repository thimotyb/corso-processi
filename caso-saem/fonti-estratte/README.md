...
- `scratchpad-requisiti-processo.md`: evidenze sulla raccolta, derivazione, specifica e gestione iterativa dei requisiti, con riferimenti puntuali alla documentazione del caso.
...
Fonte: `resources/casoSAEM.pdf`, documentazione del caso SAEM di C. Bozzoli e T. Barbieri. Il dossier conserva un estratto di lavoro della fonte già presente nel progetto.
